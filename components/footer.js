          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-auto h-10 flex items-center justify-center">
                <Image src={logo || "/placeholder-user.jpg"} alt="Baroque Variations Logo" width={150} height={120} />
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <form onSubmit={handleSubmit} className="flex gap-2">
                <input
                  ...
                  required
                  className="flex-1 px-4 py-2.5 bg-slate-800 border border-slate-700 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-500 text-white placeholder-slate-400"
                />
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="px-6 py-2.5 bg-orange-600 hover:bg-orange-700 rounded-full text-white font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-3">
              <a
                href="#"
                aria-label="LinkedIn"
                className="w-9 h-9 bg-slate-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition-colors"
              >
