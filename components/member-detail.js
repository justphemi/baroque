      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="border-slate-100 shadow-sm mb-8">
            ...
            <div className="w-32 h-32 rounded-full flex items-center justify-center mx-auto mb-4 overflow-hidden bg-slate-100 ring-4 ring-orange-50">
                  <Image
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="flex justify-center md:justify-start space-x-3 mb-6">
                    {member.social.linkedin && (
                      <a
                        ...
                        className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center text-slate-600 hover:bg-orange-600 hover:text-white transition-colors"
                      >
                  ...
                  <p className="text-slate-700 leading-relaxed">{member.shortBio}</p>
                </div>
              </div>
            </CardContent>
          </Card>
